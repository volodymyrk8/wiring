...
GLOSS = {
    "asd": {
        ...
        "blurb": "Спектр, не одна картинка. Часто: сенсорика, скрипты, буквальность, специальный интерес, усталость от маски. Это не «нет эмпатии» и не отсутствие юмора.",
    },
    "adhd": {
        "expand": "ADHD — Attention-Deficit/Hyperactivity Disorder, СДВГ",
        "blurb": "Внимание не выключено — оно прыгает. Гиперфокус, дедлайны как миф, импульс, забытые сообщения. Не лень и не «просто соберись».",
    },
    "audhd": {
        "expand": "AuDHD — аутизм + СДВГ сразу",
        "blurb": "Два ядра в одном процессоре: нужна рутина и она же душит. Частый комбо, не «не определился(ась)».",
    },
    "bpd": {
        "expand": "BPD — Borderline Personality Disorder, ПРЛ",
        "blurb": "Чувства очень громкие, страх брошенности, мир то идеальный, то пустой. Это не синоним «токсичный человек».",
    },
    "ocd": {
        "expand": "OCD — Obsessive-Compulsive Disorder, ОКР",
        "blurb": "Навязчивые мысли и ритуалы, которые на секунду их глушат. Не про «люблю чистоту и списки».",
    },
    "bipolar": {
        "expand": "БАР — биполярное аффективное расстройство",
        "blurb": "Эпизоды подъёма и спада, не «сегодня грустно, завтра весело». Амплитуда больше настроения.",
    },
    "cptsd": {
        "expand": "CPTSD — Complex PTSD, комплексное ПТСР",
        "blurb": "Длинная или повторная травма. Тело часто реагирует раньше головы. Не «просто тревожный характер».",
    },
    "anxiety": {
        "expand": "тревожное расстройство / тревожный спектр",
        "blurb": "Мозг заранее пишет катастрофу. Проверка, избегание, бессонница. Не «просто волнуется».",
    },
    "depression": {
        "expand": "депрессия",
        "blurb": "Не грусть на вечер. Пропадают батарея, смысл, иногда вкус еды и сообщений.",
    },
    "dyslexia": {
        "expand": "дислексия",
        "blurb": "Мысль быстрее, чем чтение и письмо. Не про интеллект.",
    },
    "dyspraxia": {
        "expand": "диспраксия",
        "blurb": "План «просто сделай» и тело расходятся. Координация, последовательность действий, «неуклюжесть» как диагноз, не как шутка.",
    },
    "tourette": {
        "expand": "синдром Туретта",
        "blurb": "Тики: движения или звуки, которые не выбирают. Не характер и не подкол.",
    },
    "pda": {
