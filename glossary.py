...
GLOSS = {
    ...
    "selfdx": {
        "expand": "self-dx — самодиагностика",
        "blurb": "Самоназвание без официальной бумаги. На WIRING это считается: очередь к специалисту не всем доступна.",
    },
    "prodx": {
        "expand": "pro-dx — официальный диагноз",
        "blurb": "Есть заключение врача. Не делает человека «настоящее», чем self-dx.",
    },
    "latedx": {
        "expand": "late-diagnosed — узнали о себе поздно",
        "blurb": "Часто после 20. Много лет маски и ощущения, что все получили инструкцию, кроме тебя.",
    },
    "masking": {
    ...
    "empath": {
        "expand": "эмпат — сильно считывает чужое",
        "blurb": "Комната заходит в тело раньше разговора. Не магический суперсила-титул, описание чувствительности.",
    },
    "terminally-online": {
