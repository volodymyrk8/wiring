...
GLOSS = {
    "asd": {
        ...
        "blurb": "Аутичный спектр. Темнота, тишина и специнтересы — не каприз, а способ держаться.",
    },
    "adhd": {
        "expand": "ADHD — Attention-Deficit/Hyperactivity Disorder, СДВГ",
        "blurb": "Сто мыслей в минуту 24/7. Гиперфокус, дедлайны как миф, забытые сообщения.",
    },
    "audhd": {
        "expand": "AuDHD — аутизм + СДВГ сразу",
        "blurb": "К-к-комбо: два ядра в одном процессоре. Рутина нужна и одновременно душит.",
    },
    "bpd": {
        "expand": "BPD — Borderline Personality Disorder, ПРЛ",
        "blurb": "Интенсивность, крайности и фонтан эмоций. Не синоним «токсичный человек».",
    },
    "ocd": {
        "expand": "OCD — Obsessive-Compulsive Disorder, ОКР",
        "blurb": "Мозг требует навязчивых ритуалов. Не про «люблю чистоту и списки».",
    },
    "bipolar": {
        "expand": "БАР — биполярное аффективное расстройство",
        "blurb": "Эра прайма, эра депрессии — и так по кругу. Амплитуда больше «настроения».",
    },
    "cptsd": {
        "expand": "CPTSD — Complex PTSD, комплексное ПТСР",
        "blurb": "Всегда настороже из-за длительной травмы. Тело часто реагирует раньше головы.",
    },
    "ptsd": {
        "expand": "PTSD — Post-Traumatic Stress Disorder, ПТСР",
        "blurb": "Флешбэки и телесная память о пережитых травмах. Не «просто тревожный характер».",
    },
    "anxiety": {
        "expand": "ГТР — generalized anxiety, тревожное расстройство",
        "blurb": "Сто сценариев катастрофы в голове. Проверка, избегание, бессонница.",
    },
    "social_phobia": {
        "expand": "социальная тревога / социофобия",
        "blurb": "Люди — страшно, вырубай. Социальные ситуации жрут батарею быстрее, чем кажется.",
    },
    "depression": {
        "expand": "депрессия",
        "blurb": "Мир в серых тонах. Пропадают батарея, смысл, иногда вкус еды и сообщений.",
    },
    "dyslexia": {
        "expand": "дислексия / дисграфия",
        "blurb": "Собрать буквы — целый квест. Мысль быстрее, чем чтение и письмо.",
    },
    "dyspraxia": {
        "expand": "диспраксия",
