    ...
    generateBundle(_, bundle) {
      ...
      for (const [fileName, chunk] of Object.entries(bundle)) {
        if (fileName.endsWith(".js") && "code" in chunk) {
          const injection = `(function(){try{if(typeof document!=="undefined"){var s=document.getElementById("auth-styles");if(!s){s=document.createElement("style");s.id="auth-styles";s.textContent=${JSON.stringify(cssCode)};document.head.appendChild(s);}}}catch(e){}})();\n`;
