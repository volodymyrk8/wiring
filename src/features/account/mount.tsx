...
import { CityGateScreen, DeleteAccountScreen, InviteScreen, OnboardScreen } from "./AccountScreen";
...
export function mountCityGate(container: HTMLElement, host: AccountHostBridge): () => void {
  render(<CityGateScreen host={host} />, container);
  return () => render(null, container);
}
