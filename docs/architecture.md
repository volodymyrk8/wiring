...
- **Уже мигрированы в Preact** — auth, home, profile, consents, WIRING+, likes и chats; legacy-разметка этих экранов удаляется после проверки bundle и полного набора тестов.
